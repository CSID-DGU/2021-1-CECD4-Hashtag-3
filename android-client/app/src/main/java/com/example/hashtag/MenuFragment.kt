...
//        }
    ...
    override fun onCreateView(
        ...
        view.btn_photo2.setOnClickListener {
            login_id?.let { it1 -> login_email?.let { it2 -> naviActivity?.callUpload(it1, it2) } }
        }
        view.btn_video2.setOnClickListener {
            login_id?.let { it1 -> login_email?.let { it2 -> naviActivity?.callVideo(it1, it2) } }
        }
        return view }
