...
import com.bintang.apiuploadimage.upload.UploadActivity
import com.bintang.apiuploadimage.upload.model.EmailResponse
...
class PayActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        emailBtn.setOnClickListener {
           ...
           {
//               Log.d("email",edit_email.getText().toString())
